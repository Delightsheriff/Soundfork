...
Build and launch: `./scripts/build-app.sh && open build/AudioRouter.app`
Watch the logs: `log stream --level info --predicate 'subsystem == "dev.local.AudioRouter"'`
...
| 6 | Route active | Quit AudioRouter | App goes back to the system default immediately |
| 7 ✅ | Route saved | Relaunch AudioRouter | Route comes back without touching anything (verified 2026-09-24) |
